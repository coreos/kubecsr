...
type Interface interface {
	...
	GetInstanceGroupID(string) (string, error)
}

var (
	// ErrInstanceNotFound occurs when instance is not found.
	ErrInstanceNotFound = errors.New("instance not found")
	// ErrInstanceGroupNotFound occurs when instance group is not found
